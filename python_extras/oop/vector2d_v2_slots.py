...
class Vector2d:
    __slots__ = ('__x', '__y') # Tell the interpreter these are the instance attributes in this class
    
    typcode = 'd' # class attribute used to converted `Vector2d` instances to/from bytes
